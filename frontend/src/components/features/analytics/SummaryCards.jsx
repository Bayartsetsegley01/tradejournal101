...
const RANGE_LABELS = {
  ...
  '1y': '1 жилийн',
  all: 'Бүх хугацааны',
  custom: 'Сонгосон хугацааны',
};

function StatCard({ title, value, isPositive, icon: Icon }) {
  return (
...
export function SummaryCards({ data, timeRange = 'all' }) {
  ...
  const rangeLabel = RANGE_LABELS[timeRange] || 'Сонгосон хугацааны';
    ...
    <div className="flex flex-col gap-3">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          isPositive={data.profitFactor >= 1}
          icon={Activity}
        />
        <StatCard
          title={t('totalTradesLabel')}
