...
export const addTrade = async (req, res) => {
  try {
    ...
    const emotionBefore = b.emotionBefore != null ? b.emotionBefore : (b.emotion_before || null);
    const emotionAfter  = b.emotionAfter  != null ? b.emotionAfter  : (b.emotion_after  || null);
    const positiveTags  = b.positiveTags  != null ? b.positiveTags  : (b.positive_tags  != null ? b.positive_tags  : '[]');
    const mistakeTags   = b.mistakeTags   != null ? b.mistakeTags   : (b.mistake_tags   != null ? b.mistake_tags   : '[]');
